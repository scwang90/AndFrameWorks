...
public class FeedbackFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return view = inflater.inflate(Resources.layout
                .avoscloud_feedback_activity_conversation(inflater.getContext()), container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new FeedbackListAdapter(getContext());
        thread = agent.getDefaultThread();
        feedbackListView = (ListView) view.findViewById(Resources.id
                .avoscloud_feedback_thread_list(getContext()));
        feedbackListView.setAdapter(adapter);
        sendButton = (Button) view.findViewById(Resources.id
                .avoscloud_feedback_send(getContext()));
        imageButton = (ImageView) view.findViewById(Resources.id
                .avoscloud_feedback_add_image(getContext()));
        feedbackInput = (EditText) view.findViewById(Resources.id
                .avoscloud_feedback_input(getContext()));
                    ...
                    startActivityForResult(
                            Intent.createChooser(
                                    ...
                                    getResources()
                                            .getString(
                                                    Resources.string
                                                            .avoscloud_feedback_select_image(getContext()))),
                            IMAGE_REQUEST);
                } else {
        ...
        feedbackInput.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before,
                ...
                if (AVUtils.isBlankString(s.toString()) && !animating.get()
                    ...
                    set2.setInterpolator(getContext(),
                ...
                } else if (!AVUtils.isBlankString(s.toString())
                        && !animating.get()
        ...
        contact = (EditText) view.findViewById(Resources.id
                .avoscloud_feedback_contact(getContext()));
    ...
    public class FeedbackListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                if (this.getItemViewType(position) == 0) {
                    convertView = inflater
                            .inflate(
                                    Resources.layout
                                            .avoscloud_feedback_user_reply(getContext()),
                                    null);
                } else {
                    convertView = inflater.inflate(Resources.layout
                                    .avoscloud_feedback_dev_reply(getContext()),
                            null);
                }
                holder = new ViewHolder();
                holder.content = (TextView) convertView
                        .findViewById(Resources.id
                                .avoscloud_feedback_content(getContext()));
                holder.timestamp = (TextView) convertView
                        .findViewById(Resources.id
                                .avoscloud_feedback_timestamp(getContext()));
                holder.image = (ImageView) convertView
                        .findViewById(Resources.id
                                .avoscloud_feedback_image(getContext()));
            ...
            if (comment.getAttachment() != null
                    && comment.getAttachment().getUrl() != null) {
                ...
                final View.OnClickListener imageOnClickListener = new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.setDataAndType(
                                Uri.fromFile(ImageCache.getCacheFile(comment
                                        .getAttachment().getUrl())), "image/*");
                        startActivity(intent);
                    }
                };
                Bitmap attachmentCache = cache.getImage(comment.getAttachment()
                        .getUrl());
                if (attachmentCache != null) {
                    ...
                    comment.getAttachment().getDataInBackground(
                            new GetDataCallback() {

                                @Override
                                public void done(byte[] data, AVException e) {
                                    if (e == null) {
                                        Bitmap attachmentCache = cache
                                                .setImage(comment
                                                        .getAttachment()
                                                        .getUrl(), data);
                                        holder.image
                                                .setImageBitmap(attachmentCache);
                                        holder.image
                                                .setOnClickListener(imageOnClickListener);
                                    }
                                }
                            });
                }
            ...
            if (Math.abs(comment.getCreatedAt().getTime()
                    - System.currentTimeMillis()) < 10000) {
                holder.timestamp
                        .setText(getResources()
                                .getString(
                                        Resources.string
                                                .avoscloud_feedback_just_now(getContext())));
            } else {
    ...
    public static class ImageCache {
        ...
        public static File getCacheFile(String fileName) {
            File imgCacheDir = new File(
                    AVOSCloud.applicationContext.getExternalCacheDir(), "img");
        ...
        public Bitmap getImage(String key) {
            ...
            if (cacheBitmap == null) {
                cacheBitmap = BitmapFactory.decodeFile(getCacheThumbnailFile(
                        key).getAbsolutePath());
            }
            return cacheBitmap;
        }
        ...
        public Bitmap setImage(String key, byte[] data) {
            ...
            try {
                ...
                os.write(data);
                thumbnailOS = new FileOutputStream(getCacheThumbnailFile(key),
                        true);
