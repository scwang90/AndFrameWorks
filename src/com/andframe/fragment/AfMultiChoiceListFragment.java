...
public abstract class AfMultiChoiceListFragment<T> extends AfListViewFragment<T> implements OnMenuItemClickListener {
	 ...
	 * @param clazz
	 */
	public AfMultiChoiceListFragment(Class<T> clazz) {
		super(clazz);
	}
	 ...
	 * @param clazz
	 */
	public AfMultiChoiceListFragment(Class<T> clazz, String KEY_CACHELIST) {
	...
	protected class AbMultiChoiceAdapter extends AfMultiChoiceAdapter<T>{
		...
		protected AfMultiChoiceItem<T> getMultiChoiceItem(T data) {
			return AfMultiChoiceListFragment.this.getMultiChoiceItemLayout(data);
		}
