...
public class FloatingActionButton extends ImageButton {
	...
	void init(Context context, AttributeSet attributeSet) {
		...
		mColorNormal = attr
				.getColor(R.styleable.FloatingActionButton_fab_colorNormal,
						0xff0099cc/* getColor(android.R.color.holo_blue_dark) */);
		mColorPressed = attr
				.getColor(R.styleable.FloatingActionButton_fab_colorPressed,
						0xff33b5e5/* getColor(android.R.color.holo_blue_light) */);
