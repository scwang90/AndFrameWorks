package com.andwidget.floatingactionbutton;
...
public class FloatingActionsMenu extends ViewGroup {
  ...
  private void init(Context context, AttributeSet attributeSet) {
    ...
    mAddButtonColorNormal = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonColorNormal, 0xff0099cc/*getColor(android.R.color.holo_blue_dark)*/);
    mAddButtonColorPressed = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonColorPressed, 0xff33b5e5/*getColor(android.R.color.holo_blue_light)*/);
  ...
  private class LayoutParams extends ViewGroup.LayoutParams {
    ...
    public LayoutParams(ViewGroup.LayoutParams source) {
      ...
      mExpandDir.setInterpolator((TimeInterpolator) sExpandInterpolator);
