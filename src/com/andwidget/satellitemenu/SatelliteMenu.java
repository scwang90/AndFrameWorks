...
public class SatelliteMenu extends FrameLayout {
	...
	private int itemSizeW = 0;
	private int itemSizeH = 0;
	...
	public void addItems(List<SatelliteMenuItem> items) {
		...
		for (SatelliteMenuItem menuItem : menuItems) {
			...
			initItemSize(itemView);
			initItemSize(cloneView);
	...
	private void initItemSize(ImageView view) {
		...
		if (this.itemSizeW > 0) {
			...
			if (this.itemSizeH > 0) {
				lpParams.height = this.itemSizeH;
			}else {
				lpParams.height = this.itemSizeW;
			}
		}
	 ...
	 * @param sizepx
	 */
	public void setItemSzie(int sizepx){
		this.itemSizeW = sizepx;
	}
	 ...
	 * @param sizepx
	 */
	public void setItemSzie(int sizewpx,int sizehpx){
		this.itemSizeW = sizewpx;
		this.itemSizeH = sizehpx;
	}
