 ...
 * @Description: 图片处理工具类
 * @Author: scwang
 * @Version: V1.0, 2015-3-13 下午4:53:37
 * @Modified: 初次创建AfImageHelper类
 */
public class AfImageHelper {
	 ...
	 */
	public static BitmapDrawable toGrayBitmap(Context context,
	 ...
	 * @return 返回新的bitmap
	 */
	public static Bitmap toRoundCornerBitmap(Bitmap bitmap,boolean recycle) {
		int width = bitmap.getWidth();
		int height = bitmap.getHeight();
		float roundPx;
		float left, top, right, bottom, dst_left, dst_top, dst_right, dst_bottom;
	...
	public static BitmapDrawable toRoundBitmap(Context context,
	...
	public static BitmapDrawable toRoundCornerBitmap(Context context,
			BitmapDrawable bitmap,boolean recycle) {
		// TODO Auto-generated method stub
