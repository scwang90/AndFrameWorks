...
import com.ontheway.caches.AfDurableCache;
import com.ontheway.model.Exceptional;
import com.ontheway.util.AfDateFormat;
		...
		new Thread(){
			public void run() {
				try {
					...
					Builder tDialog = new Builder(tactivity);
					tDialog.setTitle(ttitle);
					tDialog.setCancelable(false);
					tDialog.setMessage(tmsg);
					tDialog.setNeutralButton("我知道了", 
						new OnClickListener() {
							@Override
