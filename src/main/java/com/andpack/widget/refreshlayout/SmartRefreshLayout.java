package com.andpack.widget.refreshlayout;
...
import com.andpack.widget.refreshlayout.api.RefreshContent;
...
import com.andpack.widget.refreshlayout.footer.ballpulse.BallPulseFooter;
import com.andpack.widget.refreshlayout.header.bezier.BezierHeader;
import com.andpack.widget.refreshlayout.impl.RefreshBottomWrapper;
import com.andpack.widget.refreshlayout.impl.RefreshContentWrapper;
import com.andpack.widget.refreshlayout.impl.RefreshHeaderWrapper;
import com.andpack.widget.refreshlayout.listener.OnLoadmoreListener;
import com.andpack.widget.refreshlayout.listener.OnMultiPurposeListener;
import com.andpack.widget.refreshlayout.listener.OnRefreshListener;
import com.andpack.widget.refreshlayout.listener.OnRefreshLoadmoreListener;
...
public class SmartRefreshLayout extends ViewGroup  implements NestedScrollingParent, NestedScrollingChild {
    ...
    protected long mReboundDuration = 200;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHeaderHeight = DensityUtil.dp2px(100);
        mFooterHeight = DensityUtil.dp2px(60);
        mExtendHeaderHeight = (int) (mHeaderHeight * 1.2f);
        mExtendFooterHeight = (int) (mFooterHeight * 1.2f);
        mReboundDuration = 300;
    ...
    protected void onAttachedToWindow() {
        ...
        if (mPrimaryColors != null) {
            if (mRefreshHeader != null) {
                mRefreshHeader.setPrimaryColor(mPrimaryColors);
            }
            if (mRefreshFooter != null) {
                mRefreshFooter.setPrimaryColor(mPrimaryColors);
            }
        }
    }
...
//        }
    ...
    public SmartRefreshLayout setFooterHeightDp(float height) {
        this.mFooterHeight = DensityUtil.dp2px(height);
        return this;
    }
    ...
    public SmartRefreshLayout setHeaderHeightDp(float height) {
        this.mHeaderHeight = DensityUtil.dp2px(height);
        return this;
    }
    ...
    public SmartRefreshLayout setExtendHeaderHeightDp(float height) {
        this.mExtendHeaderHeight = DensityUtil.dp2px(height);
        return this;
    }
    ...
    public SmartRefreshLayout setExtendFooterHeightDp(float height) {
        this.mExtendFooterHeight = DensityUtil.dp2px(height);
        return this;
    }
    ...
    public SmartRefreshLayout setPrimaryColors(int... colors) {
        if (mRefreshHeader != null) {
            mRefreshHeader.setPrimaryColor(colors);
        }
        if (mRefreshFooter != null) {
            mRefreshFooter.setPrimaryColor(colors);
        }
