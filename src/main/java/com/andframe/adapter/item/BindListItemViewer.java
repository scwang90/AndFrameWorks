...
public class BindListItemViewer<T> extends SelectTreeItemViewer<T> {

    View[] bindViews = null;
    BindItemMap bindMap;

    public BindListItemViewer(int layoutId, BindItemMap bindMap) {
        super(layoutId);
        this.bindMap = bindMap;
    }

    public BindListItemViewer(int layoutId, Object... binds) {
        super(layoutId);
