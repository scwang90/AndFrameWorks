...
public class TableView extends HorizontalScrollView {
	...
	protected TableItemAdapter mAdapter = null;
	...
	public void setAdapter(TableItemAdapter adapter) {
		mAdapter = adapter;
		if (mHeader != null) {
			mLayout.removeView(mHeader);
			mHeader = null;
		}
		Table table = mAdapter.getTable();
	...
	public static class AfTableHeader extends LinearLayout {
		...
		public AfTableHeader(Context context, Table table) {
			super(context);
