...
//	}
	...
	public boolean removeHeaderView(View v) {
		return mTargetView instanceof ListView && ((ListView) mTargetView).removeHeaderView(v);
	}

	public boolean removeFooterView(View v) {
		return mTargetView instanceof ListView && ((ListView) mTargetView).removeFooterView(v);
	}
