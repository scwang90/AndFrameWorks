...
public class CheckBoxModule extends AbstractViewModule implements OnClickListener{
    ...
    public CheckBoxModule(@NonNull CompoundButton checkbox) {
        initializeComponent(checkbox);
    }

    public CheckBoxModule(@NonNull Viewer viewer, int id) {
