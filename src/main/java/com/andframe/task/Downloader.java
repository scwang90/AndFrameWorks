...
public class Downloader {
    ...
    public static class DownloadEntity {
        ...
        public DownloadEntity(@NonNull String url, @NonNull String path) {
        ...
        public boolean equals(@Nullable Object obj) {
            if (obj instanceof DownloadEntity) {
                ...
                return TextUtils.equals(DownloadUrl, ((DownloadEntity) obj).DownloadUrl);
            }
    ...
    protected static class Notifier {
        ...
        public Notifier(Context context, DownloadEntity entity) {
            ...
            mBuilder.setChannelId(entity.getChannelId());
...
//			mBuilder.setTicker("背景下载完成，点击设置");
    ...
    public static class DownloadTask extends AbstractTask implements Handler.Callback {
        ...
        DownloadTask(@NonNull DownloadEntity entity, DownloadListener listener) {
            mEntity = entity;
         ...
         * 如果等于 传入的监听器 绑定成功 否则 上一个监听器拒绝新的绑定
         */
        DownloadListener setDownloadListener(DownloadListener listener) {
        ...
        protected boolean onPrepare() {
            ...
            for (DownloadTask task : mltDownloading) {
                if (task.mEntity.equals(mEntity)) {
...
//                }
    ...
    protected static class DownloadBroadcast extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                $.error().handle(e, "DownloadBroadcast.onReceive");
            }
        }
    }
    ...
    static {
        try {
            ...
            $.error().handle(e, "DownloadBroadcast.registerReceiver error");
        }
    }
}
