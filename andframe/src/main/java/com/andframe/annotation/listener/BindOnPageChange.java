 ...
 * <pre><code>
 * {@literal @}BindOnPageChange(R.id.example_pager) void onPageSelected(int position) {
 ...
 * <pre><code>
 * {@literal @}BindOnPageChange(value = R.id.example_pager, callback = PAGE_SCROLL_STATE_CHANGED)
...
@ListenerClass(
        ...
        callbacks = BindOnPageChange.Callback.class
)
public @interface BindOnPageChange {
    /**
