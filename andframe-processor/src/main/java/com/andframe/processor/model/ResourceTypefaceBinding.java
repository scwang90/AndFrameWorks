...
public class ResourceTypefaceBinding extends ResourceBinding {
    ...
    public enum TypefaceStyles {
        ...
        public static TypefaceStyles fromValue(int value) {
    ...
    public ResourceTypefaceBinding(Id id, String name, TypefaceStyles style) {
        this.id = id;
        this.name = name;
        this.style = style;
    }
